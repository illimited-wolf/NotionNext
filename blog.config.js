...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'illimited', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.illimited.eu.org', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Blog, Tech, Computer, Radio, Software', // 网站关键词 英文逗号隔开
